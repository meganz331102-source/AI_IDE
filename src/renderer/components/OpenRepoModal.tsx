    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="glass flex h-[600px] w-[640px] flex-col overflow-hidden rounded-2xl ring-1 ring-white/10 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {!hasToken && (
            <div className="mb-5 rounded-xl bg-[#57cc99]/[0.08] p-4 ring-1 ring-[#38a3a5]/40">
              <div className="mb-2 flex items-center gap-2">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-[#80ed99]"><path d="M12 .3a12 12 0 0 0-3.8 23.4c.6.1.8-.3.8-.6v-2.1c-3.3.7-4-1.6-4-1.6-.5-1.4-1.3-1.8-1.3-1.8-1.1-.7.1-.7.1-.7 1.2.1 1.8 1.2 1.8 1.2 1.1 1.8 2.8 1.3 3.5 1 .1-.8.4-1.3.8-1.6-2.7-.3-5.5-1.3-5.5-6 0-1.3.5-2.4 1.2-3.2-.1-.3-.5-1.5.1-3.2 0 0 1-.3 3.3 1.2a11.4 11.4 0 0 1 6 0c2.3-1.5 3.3-1.2 3.3-1.2.7 1.7.2 2.9.1 3.2.8.8 1.2 1.9 1.2 3.2 0 4.6-2.8 5.6-5.5 5.9.4.4.8 1.1.8 2.2v3.3c0 .3.2.7.8.6A12 12 0 0 0 12 .3z"/></svg>
                <span className="text-[12px] font-medium text-[#c7f9cc]">Połącz konto GitHub</span>
              </div>
              <p className="mb-2 text-[10.5px] text-[#80ed99]/80">Wygeneruj Personal Access Token (zakres: repo), wklej poniżej.</p>
              <button
          ...
          <div className="mb-5">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-md bg-white/[0.04] px-3 py-1.5 text-[12px] text-neutral-100 ring-1 ring-white/[0.08] outline-none focus:ring-[#38a3a5]/50"
              />
              <button
                onClick={cloneCustom}
          ...
          {user && (
            <div>
              ...
              <input
                ...
                placeholder="Filtruj..."
                className="mb-2 w-full rounded-md bg-white/[0.04] px-3 py-1.5 text-[12px] text-neutral-200 ring-1 ring-white/[0.08] outline-none focus:ring-[#38a3a5]/50"
              />
              {loadingRepos ? (
                  ...
                  {filtered?.map((r) => (
                    <div key={r.fullName} className="flex items-center gap-2 rounded-md px-2.5 py-2 hover:bg-white/[0.04]">
                      ...
                      <button
                        ...
                        disabled={!!cloning}
                        className="shrink-0 rounded-md bg-[#38a3a5] px-2.5 py-1 text-[10.5px] font-medium text-white hover:bg-[#57cc99] disabled:opacity-40"
                      >
